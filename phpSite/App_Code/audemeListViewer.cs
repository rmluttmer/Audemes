...
public class audemeListViewer
{
	...
	{        
        ...
        audemeList.ForEach(delegate(Audeme audeme)
        {
            ...
            if (listType == (Int16)enumListType.DashboardList)
            {
                ...
                listHTML += "<a class='clickable removeFromDashboard' id='" + audeme.getID() + "'>Remove</a>";
            ...
            {
                //Remove from Session
                listHTML += "<a class='clickable' id='" + audeme.getID() + "' href='/formHandlers/removeAudemeFromSession.aspx?";
    ...
    public static string viewAsSearchList_SoundEffectsOnly(List<Audeme> audemeList)
    {
        ...
        audemeList.ForEach(delegate(Audeme audeme)
        {
            listHTML += "<li id='listID" + audeme.getID() + "'><div class='name showDetails' href=''>";
