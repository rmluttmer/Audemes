            ...
            <div id="content">
                ...
                <%
                    ...
                    if (!isNum)
                    {
                        ...
                        Response.Write("Please select a different audeme on the <a href='/jhesch/dictionary'>Dictionary</a><br />");
                    ...
                    else
                    {
                        ...
                        if (myAudeme.getRelatedAudemes() != "" && myAudeme.getRelatedAudemes() != null)
                        {
                            ...
                            relatedList.ForEach(delegate(string related)
                            {
                                ...
                                generalInfo += "<a href='/jhesch/audemeFactSheet.aspx?AudemeID=" + relatedAudeme.getID() + "'>" + relatedAudeme.getName() + "</a>, ";
                            });
                        ...
                        if (myAudeme.getCreator() != "")
                        {
                            ...
                            generalInfo += "<p><i>Creator: </i> <a href='/jhesch/userInfo.aspx?UserID=" + myUser.getUserID() + "'>" + myUser.getUserName() + "</a></p>";
                        }   
                        ...
                        //Feedback form stuff
                        generalInfo += "<form class='form' name='form_request' id='form_request' action='/jhesch/formHandlers/audemeFactSheetForm.aspx'>";
