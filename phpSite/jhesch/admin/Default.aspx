        ...
        <div id="container">  <!--  Free CSS Template from www.TemplateMo.com  -->
            ...
            <div id="content">
            	<asp:Panel id="content_left" runat="server">
                    ...
                    <asp:HyperLink NavigateUrl="/jhesch/default.aspx" Text="Audeme Home Page" ID="HyperLink1" runat="server"></asp:HyperLink>
                    <br /><br />
                    <asp:HyperLink NavigateUrl="/jhesch/dictionary/locked.aspx" Text="View Locked Audemes" ID="lnkViewLocked" runat="server"></asp:HyperLink>
                    <br /><br />
