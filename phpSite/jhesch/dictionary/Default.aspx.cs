...
public partial class jhesch_dictionary_Default3 : System.Web.UI.Page
{
    ...
    protected void initializePanelVisibility()
    {
        if (!String.IsNullOrEmpty(searchTerm))
        {
            ...
            {
                pnlResults_Audemes.Visible = true;
                results_Audemes.InnerHtml = "<p style='color: red'>You must search for at least one type of content (audemes, sound effects, or grids).  Please check the appropriate box(es) and click search again.</p>";
            }
