        ...
        <div id="container">  <!--  Free CSS Template from www.TemplateMo.com  -->
            ...
            <div id="content">
                ...
                <% 
                    ...
                    {
                        pageText += "<div class='title'>My Sets</div>";
                        pageText += @"<ul id='dashboardNav'>
                                            <li><a href='Default.aspx' class='clickable'>Audemes</a></li>
                                            <li><a class='clickable' href='createSession.aspx'>Create Set</a></li>
                                            <li><a href='Grids.aspx' class='clickable'>Grids</a></li>
                                            <li><a href='/formHandlers/logout.aspx'>Sign Out</a></li>
                                    </ul>";
                        pageText += "<br />";
                        ...
                        if (mySessionList.Count > 0)
                        {
                            ...
                            {
                                pageText += "<p class='sessionName'>" + myAudemeSession.audemeSessionName + " (<a class='clickable' href='/formHandlers/deleteSession.aspx?sessionID=" + myAudemeSession.audemeSessionID + "'>delete</a>)</p>";
                        ...
                        {
                            pageText += "<br />No sets found.  Click the \"Create Set\" link (above) to create a new sets.";
                        }
