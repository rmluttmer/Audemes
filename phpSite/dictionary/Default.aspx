                        ...
                        <table style="width: 780px;">
                            <tr>
                                ...
                                <td style="width: 490px;">
                                    Search:<br />
                                    <asp:TextBox Width="350" ID="txtSearchTerm" placeholder="What are you looking for?" runat="server"></asp:TextBox><br />
                                    <asp:CheckBox ID="chkAudemes" Text="Audemes" Checked="true" runat="server" Tooltip="Audemes are brief audio collages that combine sound effects to form aural symbols that signify various ideas." /><br />
                                    <asp:CheckBox ID="chkSoundEffects" Text="Atomic&nbsp;Sounds" runat="server"  Tooltip="Atomic Sounds are simple sounds that can be combined to create audemes." /><br />
                                    <asp:CheckBox ID="chkGrids" Text="Game&nbsp;Boards&nbsp;and&nbsp;Grids" runat="server" Tooltip="Grids are groups of audemes and atomic sounds organized in thematic groups."  /><br />
