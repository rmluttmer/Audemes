...
public partial class jhesch_dictionary_Default3 : System.Web.UI.Page
{
    ...
    protected void Search(string strTerm)
    {
        ...
        if (chkAudemes.Checked)
        {
            ...
            if (audemeList.Count >= 50)
            {
                lblAudemeCount.Text = "More than 50 audemes were found.  The first 50 are listed below.";
            }
            else
            {
                lblAudemeCount.Text = audemeList.Count + " audemes were found.";
            }
        ...
        if (chkSoundEffects.Checked)
        {
            ...
            if (audemeList.Count >= 50)
            {
                lblSoundEffectCount.Text = "More than 50 atomic sounds were found.  The first 50 are listed below.";
            }
            else
            {
                lblSoundEffectCount.Text = audemeList.Count + " atomic sounds were found.";
            }
        }
    }
