                ...
                <% 
                    ...
                    if (Session["user_id"] != null && Session["user_id"] != "")
                    {
                        ...
                        pageText += @"<ul id='dashboardNav'>
                                            ...
                                            <li><a class='clickable' href='Sessions.aspx'>Sets</a></li>
                                            <li><a href='/contribute/GridCreator.aspx' class='clickable'>Create Grids</a></li>
                        ...
                        {
                            pageText += "<p>No grids found in your locker.  <br />Find grids in the <a href='/dictionary/'>Dictionary</a></p>";
                        }
