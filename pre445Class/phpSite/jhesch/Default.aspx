                    ...
                    <div class="cs_wrapper">
                        <div class="cs_slider">
                            ...
                            <div class="cs_article">
                                <a href="#">
                                <img src="/jhesch/images/articles/sound.jpg" alt="Sound Wave" />
                                </a>
                                
                                <div class="text">
                                    <h2> <a href="#">Take a look!</a> </h2>
                                    
                                    <p>
							        Welcome to the audemes web site.  
                                    </p>
                                    
                                    <p>Take a look at our database of audemes in the <a href="/jhesch/dictionary">Dictionary</a>.</p>
                                    <p>Use pre-built audeme collections from the <a href="/jhesch/games">Games</a> section.</p>
                                    <p>Store and sort your favorite audemes in the <a href="/jhesch/dashboard">Dashboard</a>.</p>
                                    <p>Let us know what you think about the whole thing by <a href="/jhesch/contact">Contacting Us</a>.</p>
                   		        </div>
                	        </div><!-- End cs_article -->
                            
                            <div class="cs_article">
                                <a href="#">
                                <img src="/jhesch/images/articles/volcano.jpg" alt="Volcano exploding" />
                                </a>
                                ...
                                <div class="text">
                                    ...
                                    <script type="text/javascript">
                                        var clicksound16 = createsoundbite('/jhesch/MP3s/audemes/6 Earth Sci 200 pts VOLCANO  1-2-7.mp3'); var audemeID = 16;
                                    </script>
